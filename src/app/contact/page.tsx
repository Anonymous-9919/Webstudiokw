...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE.url}/opengraph-image.png`, width: 1200, height: 630, alt: "Contact WebStudioKW, web design and development agency in Kuwait" }],
  },
  twitter: { card: "summary_large_image", title: "Contact Us | WebStudioKW", description: "Contact WebStudioKW for professional website development in Kuwait. Get a free quote.", images: [`${SITE.url}/opengraph-image.png`], creator: "@webstudiokw" },
