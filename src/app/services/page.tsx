...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE.url}/opengraph-image.png`, width: 1200, height: 630, alt: "WebStudioKW web development services: website design, ecommerce, and custom web apps in Kuwait" }],
  },
  twitter: {
